...
player2 = Person("Captain America  ",4160,188,311,34,player_spells,player_items)
player3 = Person("Thor             ",3089,174,288,34,player_spells,player_items)


enemy1 = Person("Ultron           ",1250,130,560,325,enemy_spells,[])
enemy2 = Person("Thanos           ",18200,701,525,25,enemy_spells,[])
enemy3 = Person("Hela             ",1250,130,560,325,enemy_spells,[])
